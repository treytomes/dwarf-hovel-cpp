...
public:
	...
	virtual void draw_bitmap_2bpp(Point2UI point, Color c0, Color c1, Color c2, Color c3, unsigned short* bitmap, unsigned int width, unsigned int height, bool flip_x = false, bool flip_y = false, float angle = 0.0f) = 0;
